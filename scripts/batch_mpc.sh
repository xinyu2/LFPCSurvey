...
# test MPC #
# ================ #
../MPC/MPC_double $DATADIR/astro_mhd_f64 1 >> $RESDIR/res_mpc.txt
../MPC/MPC_double $DATADIR/astro_pt_f64  1 >> $RESDIR/res_mpc.txt
../MPC/MPC_float  $DATADIR/citytemp_f32  1 >> $RESDIR/res_mpc.txt
../MPC/MPC_float $DATADIR/h3d_temp      1 >> $RESDIR/res_mpc.txt
../MPC/MPC_float $DATADIR/hdr_night     1 >> $RESDIR/res_mpc.txt
../MPC/MPC_float  $DATADIR/miranda3d     1 >> $RESDIR/res_mpc.txt
...
../MPC/MPC_float  $DATADIR/rsim_f32      1 >> $RESDIR/res_mpc.txt
...
../MPC/MPC_float  $DATADIR/turbulence    1 >> $RESDIR/res_mpc.txt
../MPC/MPC_float  $DATADIR/wave_f32      1 >> $RESDIR/res_mpc.txt
