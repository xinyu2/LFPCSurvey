...
# test ndzip-gpu #
# ================ #
{ $EXECDIR/ndzip/build/compress -e cuda -i $DATADIR/astro_mhd_f64 -o $DATADIR/astro_mhd_f64.ndzip2 -t double -n 68557320 ; } 2>>$RESDIR/res_ndzip_gpu.txt
{ $EXECDIR/ndzip/build/compress -e cuda -i $DATADIR/astro_pt_f64 -o $DATADIR/astro_pt_f64.ndzip2 -t double -n 83886080 ; } 2>>$RESDIR/res_ndzip_gpu.txt
...
{ $EXECDIR/ndzip/build/compress -e cuda -i $DATADIR/turbulence -o $DATADIR/turbulence.ndzip2 -t float -n 16777216 ; } 2>>$RESDIR/res_ndzip_gpu.txt
{ $EXECDIR/ndzip/build/compress -e cuda -i $DATADIR/wave_f32 -o $DATADIR/wave_f32.ndzip2 -t float -n 134217728 ; } 2>>$RESDIR/res_ndzip_gpu.txt
ls -l $DATADIR/*.ndzip2
echo "test ndzip-gpu decompress"
{ $EXECDIR/ndzip/build/compress -d -e cuda -o $DATADIR/astro_mhd_f64.ndzout2 -i $DATADIR/astro_mhd_f64.ndzip2 -t double -n 68557320 ; } 2>> $RESDIR/res_ndzip_gpu_decomp.txt
{ $EXECDIR/ndzip/build/compress -d -e cuda -o $DATADIR/astro_pt_f64.ndzout2 -i $DATADIR/astro_pt_f64.ndzip2 -t double -n 83886080 ; } 2>> $RESDIR/res_ndzip_gpu_decomp.txt
...
{ $EXECDIR/ndzip/build/compress -d -e cuda -o $DATADIR/turbulence.ndzout2 -i $DATADIR/turbulence.ndzip2 -t float -n 16777216 ; } 2>> $RESDIR/res_ndzip_gpu_decomp.txt
{ $EXECDIR/ndzip/build/compress -d -e cuda -o $DATADIR/wave_f32.ndzout2 -i $DATADIR/wave_f32.ndzip2 -t float -n 134217728 ; } 2>> $RESDIR/res_ndzip_gpu_decomp.txt
