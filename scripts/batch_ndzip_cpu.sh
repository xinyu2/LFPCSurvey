...
# test ndzip-cpu #
# ================ #
{ $EXECDIR/ndzip/build/compress -i $DATADIR/astro_mhd_f64 -o $DATADIR/astro_mhd_f64.ndzip -t double -n 130 514 1026 ; } 2>>$RESDIR/res_ndzip_cpu.txt
{ $EXECDIR/ndzip/build/compress -i $DATADIR/astro_pt_f64 -o $DATADIR/astro_pt_f64.ndzip -t double -n 512 256 640 ; } 2>>$RESDIR/res_ndzip_cpu.txt
...
{ $EXECDIR/ndzip/build/compress -i $DATADIR/h3d_temp -o $DATADIR/h3d_temp.ndzip -t float -n 100 500 500 ; } 2>>$RESDIR/res_ndzip_cpu.txt
{ $EXECDIR/ndzip/build/compress -i $DATADIR/hdr_night -o $DATADIR/hdr_night.ndzip -t float -n 5687448 ; } 2>>$RESDIR/res_ndzip_cpu.txt
...
{ $EXECDIR/ndzip/build/compress -i $DATADIR/turbulence -o $DATADIR/turbulence.ndzip -t float -n 256 256 256 ; } 2>>$RESDIR/res_ndzip_cpu.txt
{ $EXECDIR/ndzip/build/compress -i $DATADIR/wave_f32 -o $DATADIR/wave_f32.ndzip -t float -n 512 512 512 ; } 2>>$RESDIR/res_ndzip_cpu.txt
ls -l $DATADIR/*.ndzip
echo "test ndzip-cpu decompress"
{ $EXECDIR/ndzip/build/compress -d -o $DATADIR/astro_mhd_f64.ndzout -i $DATADIR/astro_mhd_f64.ndzip -t double -n 130 514 1026 ; } 2>>$RESDIR/res_ndzip_cpu_decomp.txt
{ $EXECDIR/ndzip/build/compress -d -o $DATADIR/astro_pt_f64.ndzout -i $DATADIR/astro_pt_f64.ndzip -t double -n 512 256 640 ; } 2>>$RESDIR/res_ndzip_cpu_decomp.txt
...
{ $EXECDIR/ndzip/build/compress -d -o $DATADIR/h3d_temp.ndzout -i $DATADIR/h3d_temp.ndzip -t float -n 100 500 500 ; } 2>>$RESDIR/res_ndzip_cpu_decomp.txt
{ $EXECDIR/ndzip/build/compress -d -o $DATADIR/hdr_night.ndzout -i $DATADIR/hdr_night.ndzip -t float -n 5687448 ; } 2>>$RESDIR/res_ndzip_cpu_decomp.txt
...
{ $EXECDIR/ndzip/build/compress -d -o $DATADIR/turbulence.ndzout -i $DATADIR/turbulence.ndzip -t float -n 256 256 256 ; } 2>>$RESDIR/res_ndzip_cpu_decomp.txt
{ $EXECDIR/ndzip/build/compress -d -o $DATADIR/wave_f32.ndzout -i $DATADIR/wave_f32.ndzip -t float -n 512 512 512 ; } 2>>$RESDIR/res_ndzip_cpu_decomp.txt
ls -l $DATADIR/*.ndzout
