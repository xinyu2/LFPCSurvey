...
{ ../fpzip/build/bin/fpzip -i $DATADIR/h3d_temp -o $DATADIR/h3d_temp.fpzip -t float -3 100 500 500 ; } 2>> $RESDIR/res_fpzip.txt
{ ../fpzip/build/bin/fpzip -i $DATADIR/hdr_night -o $DATADIR/hdr_night.fpzip -t float -1 5687448 ; } 2>> $RESDIR/res_fpzip.txt
...
{ ../fpzip/build/bin/fpzip -i $DATADIR/astro_mhd_f64 -o $DATADIR/astro_mhd_f64.fpzip -t double -3 130 514 1026 ; } 2>> $RESDIR/res_fpzip.txt
{ ../fpzip/build/bin/fpzip -i $DATADIR/astro_pt_f64 -o $DATADIR/astro_pt_f64.fpzip -t double -3 512 256 640 ; } 2>> $RESDIR/res_fpzip.txt
{ ../fpzip/build/bin/fpzip -i $DATADIR/citytemp_f32 -o $DATADIR/citytemp_f32.fpzip -t float -1 2906326 ; } 2>> $RESDIR/res_fpzip.txt
{ ../fpzip/build/bin/fpzip -i $DATADIR/h3d_temp -o $DATADIR/h3d_temp.fpzip -t float -3 100 500 500 ; } 2>> $RESDIR/res_fpzip.txt
{ ../fpzip/build/bin/fpzip -i $DATADIR/hdr_night -o $DATADIR/hdr_night.fpzip -t float -1 5687448 ; } 2>> $RESDIR/res_fpzip.txt
{ ../fpzip/build/bin/fpzip -i $DATADIR/miranda3d -o $DATADIR/miranda3d.fpzip -t float -3 1024 1024 1024 ; } 2>> $RESDIR/res_fpzip.txt
